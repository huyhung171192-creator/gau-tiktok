...
def handle_start(data):
    ...
    # Phản hồi tín hiệu ngay lập tức xuống điện thoại
    socketio.emit('sys_log', {'msg': f"Đang xuất chiêu dò tìm phòng live: {tiktok_id}..."})
...
if __name__ == '__main__':
    # Lấy cổng từ hệ thống Cloud của Render, mặc định là 5000 nếu test ở nhà
